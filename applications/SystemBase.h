...
//----------------------------------------------------------------------------------------------------
// Invisible bit define
//----------------------------------------------------------------------------------------------------
#define ITEM_DEBUG_INVISIBLE 0x80000000u
#define ITEM_UART_INVISIBLE  (ITEM_DEBUG_INVISIBLE | 0x00000004u)
...
#define FILE_RESERVE_SPACE_LENTH  (FILE_INFO_LENGTH + FILE_EXTRA_INFO_LENGTH)

#define FLASH_CPU_APP_START_ADDR  0x08020000u
#define FLASH_CPU_APP_SPACE_LENTH 0x000A0000u
#define FLASH_CPU_APP_MIN_LENGTH  0x80u
#define FLASH_CPU_APP_MAX_LENGTH  (FLASH_CPU_APP_SPACE_LENTH - FILE_RESERVE_SPACE_LENTH)
#define FLASH_CPU_APP_END_ADDR    (FLASH_CPU_APP_START_ADDR + FLASH_CPU_APP_SPACE_LENTH)
#define CPU_APP_FILE_INFO_ADDR    (FLASH_CPU_APP_END_ADDR -  FILE_INFO_LENGTH)
#define CPU_APP_FILE_INFO_SECTOR_START_ADDR    (CPU_APP_FILE_INFO_ADDR & 0xFFFE0000u)

#define FLASH_FPGA_APP_START_ADDR  0
#define FLASH_FPGA_APP_SPACE_LENTH 0x00400000u
#define FLASH_FPGA_APP_MIN_LENGTH  0x80u
#define FLASH_FPGA_APP_MAX_LENGTH  (FLASH_FPGA_APP_SPACE_LENTH - FILE_RESERVE_SPACE_LENTH)
#define FLASH_FPGA_APP_END_ADDR    (FLASH_FPGA_APP_START_ADDR + FLASH_FPGA_APP_SPACE_LENTH)
#define FPGA_APP_FILE_INFO_ADDR    (FLASH_FPGA_APP_END_ADDR -  FILE_INFO_LENGTH)
#define FPGA_APP_FILE_INFO_SECTOR_LENGTH        0x1000
#define FPGA_APP_FILE_INFO_SECTOR_START_ADDR    (FLASH_FPGA_APP_END_ADDR -  FPGA_APP_FILE_INFO_SECTOR_LENGTH)

#define FLASH_DEV_CFG_START_ADDR  0x080C0000u
#define FLASH_DEV_CFG_SPACE_LENTH 0x00040000u
#define FLASH_DEV_CFG_MIN_LENGTH  0
#define FLASH_DEV_CFG_MAX_LENGTH  (FLASH_DEV_CFG_SPACE_LENTH - FILE_RESERVE_SPACE_LENTH)
#define FLASH_DEV_CFG_END_ADDR    (FLASH_DEV_CFG_START_ADDR + FLASH_CPU_APP_SPACE_LENTH)

#define FLASH_ARG_START_ADDR  0x00000000u
#define FLASH_ARG_SPACE_LENTH 0x00008000u
#define FLASH_ARG_MIN_LENGTH  0
#define FLASH_ARG_MAX_LENGTH  (FLASH_ARG_SPACE_LENTH - 0x6u)
#define FLASH_ARG_END_ADDR    (FLASH_ARG_START_ADDR + FLASH_ARG_SPACE_LENTH)

#define FLASH_ARG_BACKUP_START_ADDR  0x00008000u
#define FLASH_ARG_BACKUP_END_ADDR    (FLASH_ARG_BACKUP_START_ADDR + FLASH_ARG_SPACE_LENTH)

#define FLASH_ARG_LANGUAGE_ADDR (FLASH_ARG_START_ADDR + 4)
#define FLASH_ARG_LANGUAGE_BACKUP_ADDR (FLASH_ARG_BACKUP_START_ADDR + 4)

#define EXT_RAM_START_ADDR  0x68000000u
#define EXT_RAM_SPACE_LENTH 0x00100000u
#define EXT_RAM_END_ADDR    (EXT_RAM_START_ADDR + EXT_RAM_SPACE_LENTH)

//----------------------------------------------------------------------------------------------------
// Signal related macros
//----------------------------------------------------------------------------------------------------
#define DESC_DIS_LENGTH_MAX     48
#define UINT_LENGTH_MAX     5

//----------------------------------------------------------------------------------------------------
// Cfg related macros
//----------------------------------------------------------------------------------------------------
#define CFG_PARSE_ST_SUCCESS   0x40u
#define DEV_CFG_SYSTEM_PARAMETER_PARSE_FLAG   (1 << 0u)
#define DEV_CFG_ANALOG_PARSE_FLAG             (1 << 1u)
#define DEV_CFG_SELF_DIAGNOSE_PARSE_FLAG      (1 << 2u)
#define DEV_CFG_SELF_DIAGNOSE_BIN_PARSE_FLAG  (1 << 3u)
#define DEV_CFG_BIN_INPUT_PARSE_FLAG          (1 << 4u)
#define DEV_CFG_BIN_OUTPUT_PARSE_FLAG         (1 << 5u)

//----------------------------------------------------------------------------------------------------
// CPU运行状态
//----------------------------------------------------------------------------------------------------
#define CPU_RESET_FLAG         0x0080u
#define CPU_RUNNING_FLAG       0x0001u
#define CPU_EXIT_USR_APP_FLAG  0x0002u
...
// Other
//----------------------------------------------------------------------------------------------------
#define BUFFER_PUBLIC_LENGTH   1024u
...
{
    Uint8  language;
    Uint32 cfg_parse_flag;
} SYSTEM_CFG;

//====================================================================================================
// 外部变量声明
//====================================================================================================
extern VUint8  system_running_status;
...
extern Uint16 DefaultCrcCal(Uint8 const *src, int32 length, Uint16 crc_initial);
...
extern int32 ParseDevConfig(void);
extern void WaitNS(Uint32 wait_ns);
extern void WaitUS(Uint32 wait_us);
extern void WaitMS(Uint32 wait_ms);
extern void WaitS(Uint32 wait_s);
extern void Task0NormalDefaultServices(void);
extern Uint32 GetTimerCurrentCnt(void);
extern Uint32 DiffCal(Uint32 d_end, Uint32 d_start);
extern Uint32 CalcTimeDiffToNow(Uint32 pre_timer_cnt);
extern Uint32 CalcTimeDiff(Uint32 post_timer_cnt, Uint32 pre_timer_cnt);
